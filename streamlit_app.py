...
def auto_category(merchant):
    ...
    rules = [
        ...
        (["בזק", "פרטנר", "סלקום", "הוט", "נטפליקס", "spotify", "apple", "yes", "יס"], "תקשורת"),
        (["חשמל", "חברת החשמל", "מים", "מי ", "גז", "אמישראגז", "פזגז"], "חשבונות"),
        (["מספרה", "ספר ", "barber", "hair", "קוסמטיקה", "קוסמטיק", "beauty", "nails", "ציפורניים", "לק ג׳ל", "לק ג'ל"], "טיפולי קוסמטיקה ומספרה"),
